        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Ubah <?=$namaproduk;?></h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="text" name="namaproduk" class="form-control" id="namaproduk" placeholder="Nama Produk" value="<?=$namaproduk;?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" name="deskripsi" class="form-control" id="deskripsi" placeholder="Deskripsi"  value="<?=$deskripsi;?>">
                    </div>
                    <div class="mb-3">
                        <input type="number" name="harga" class="form-control" id="harga" placeholder="Harga Produk" value="<?=$harga;?>">
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title">Hapus <?=$namaproduk;?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <input type="number" name="stok" class="form-control" id="stok" placeholder="stok Awal" required>
                    </div>
                    <div class="mb-3">
